...
<?php $page="artists.php";?>
<?php
if(isset($_POST['submit'])){

    $res=mysqli_query($connect,"SELECT ifnull(max(artistcode),0) as id from tblartist");
    ...
    if (empty($error)) {
        if($mCode>0){
          if(move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            $sql = "INSERT INTO tblartist (artistcode, artistname, image) values('$mCode','$name','$ImageName')";
            ...
            <div class="col-lg-8 offset-lg-2">
                <form method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="name" id="name" class="form-control" required="1" type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                    ...
                    <div class="m-t-20 text-center">
                        <button type="submit" id="submit" name="submit" class="btn btn-primary submit-btn">Create Artist</button>
                    </div>
                </form>
            </div>
        </div>
