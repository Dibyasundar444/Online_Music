...
$(document).ready(function(){$("footer,.footer-area").addClass("copywrite-text2"); $(".copywrite-text2").append("<b style='color:#000; margin-top:-20px; text-align:center!important; display:block!important; letter-spacing:1px;'>&nbsp;VUDIC and Techbology&nbsp;</b>");})
